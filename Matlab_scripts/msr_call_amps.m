function [note_starts, note_ends, note_durs, INI] = msr_call_amps(call, samp_rate, threshold, reset); 
% function [note_starts, note_durs, INI] = msr_call_amps(call, samp_rate,threshold, reset); 
